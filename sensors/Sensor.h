...
const std::string kTsDoubleTapPressedPath = "/sys/devices/virtual/touchscreen/primary/double_tap_pressed";
...
const std::string kTsSingleTapPressedPath = "/sys/devices/virtual/touchscreen/primary/single_tap_pressed";
